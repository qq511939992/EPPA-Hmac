...
#qqq=paillier.encrypt(paillier_pub,956586,46564,4564564)
...
for i in range(1,N+1):
    ...
    locals()[f'user{i}'].C_k_i_t = aes.encrypt(str(plain1)+","+str(plain2)+","+str(plain3)+","+str(sys_t),locals()[f'user{i}'].ki)
